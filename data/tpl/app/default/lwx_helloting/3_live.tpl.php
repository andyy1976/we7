...
<div class="ih-box ih-box__train_detail">
  <div class="ih-overflow">
    <div class="ih-box__fd ih-box__fd__live">
      <div class="ih-box__fd_fd" style="line-height:2">
    <?php  echo $note['title'];?>
     <!-- 视频连接  <?php  echo $note['video_url'];?> -->
      </div>
      <div class="ih-box__fd_hd">
        <div class="ih-btn__box">
        <!-- live_style.html -->
          <a href="javascript:;" class="ih-btn ih-btn__mini ih-href"  data-href="<?php  echo $this->createMobileUrl('good',array('op'=>'livestyle','id'=>$id));?>"  style="background-color: #e96c68;color:#fff">立即订货</a>
        </div>
      </div>
    </div>
