...
<body>
	...
	<div class="ih-box ih-box__primary">
		...
		<div class="ih-box__item ih-href" data-href="<?php  echo $this->createMobileUrl('list',array('op'=>'noteDetail','id'=>$collect['nid']));?>" data-id="<?php  echo $collect['nid'];?>">
			<div class="ih-box__hd">
				<div class="ih-border__image">
					<img src="<?php  echo $collect['avatar'];?>" alt="">
				</div>
			</div>
